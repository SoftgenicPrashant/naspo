...
const Form = () => {
  ...
  return (
    <div className="details-form-container">
      ...
      {!show ? null : (<div className="modal-container" style={{ backgroundColor:"#fff"}}>
        <div className="modal-container-body" >
          {/* <div className="card"> */}
            <h2>Form submitted succesfully</h2>
            <p className="modal-name"><span>NAME :&nbsp;</span> { fname}</p>
            <p className="modal-region"><span>REGION :&nbsp;</span>{ formData.region}</p>
